...
var x__31656__auto__ = (((x == null))?null:x);
var m__31657__auto__ = (sablono.util.to_str[goog.typeOf(x__31656__auto__)]);
if(!((m__31657__auto__ == null))){
return m__31657__auto__.call(null,x);
} else {
var m__31657__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__31657__auto____$1 == null))){
return m__31657__auto____$1.call(null,x);
} else {
...
var x__31656__auto__ = (((x == null))?null:x);
var m__31657__auto__ = (sablono.util.to_uri[goog.typeOf(x__31656__auto__)]);
if(!((m__31657__auto__ == null))){
return m__31657__auto__.call(null,x);
} else {
var m__31657__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__31657__auto____$1 == null))){
return m__31657__auto____$1.call(null,x);
} else {
...
var len__32202__auto___33357 = arguments.length;
var i__32203__auto___33358 = (0);
while(true){
if((i__32203__auto___33358 < len__32202__auto___33357)){
args__32209__auto__.push((arguments[i__32203__auto___33358]));

var G__33359 = (i__32203__auto___33358 + (1));
i__32203__auto___33358 = G__33359;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__32210__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq33356){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33356));
});
...
var vec__33360 = cljs.core.name.call(null,k).split("-");
var seq__33361 = cljs.core.seq.call(null,vec__33360);
var first__33362 = cljs.core.first.call(null,seq__33361);
var seq__33361__$1 = cljs.core.next.call(null,seq__33361);
var first_word = first__33362;
var words = seq__33361__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__33363){
var vec__33364 = p__33363;
var k = cljs.core.nth.call(null,vec__33364,(0),null);
var v = cljs.core.nth.call(null,vec__33364,(1),null);
...
return cljs.core.update.call(null,G__33367,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__33367;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__30923__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1520306971783
